<!--[ PAGINAÇÃO ]-->
<li class="text-center clearfix cx-fitros-produtos col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <span class="total-produtos col-md-4 col-xs-4">
  ...
  ?>
  <span class="paginacao-site col-md-4 col-xs-4">
  ...
  <span class="ordem-produtos col-md-4 col-xs-4">
