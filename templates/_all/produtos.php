...
// $ProdutosFiltersCores = ProdutosMenus::all( $ConditionsFilters );
...
// $ProdutosFiltersTamanhos = ProdutosMenus::all( $ConditionsFilters );
...
// $ProdutosFiltersMarcas = ProdutosMenus::all( $ConditionsFilters );
  ...
  <?php if (!$MobileDetect->isMobile()) { ?>
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 menus-lateral" id="menus-lateral" visible="false">
      <ul class="clearfix">
        ...
        <?php include dirname(__DIR__) . '/_all/produtos-filtros-lateral.php'; ?>
      </ul>
    </div>
  <?php } ?>
        ...
        <li class="<?php echo $STORE['personalize_cols_product'] ?> mb15">
          ...
          <a href="/<?php echo converter_texto($rIndex->nome_produto) ?>/<?php echo $rIndex->id ?>/p" class="cx-lista-produtos" btn-hovers>
            <div class="lista-centro-produtos black-70">
              ...
              <img src="<?php echo $STORE['PRE_LOADED']; ?>" data-original="<?php echo Imgs::src($rIndex->imagem, 'medium'); ?>" alt="<?php echo $rIndex->nome_produto ?>" class="lazy img-responsive" />
