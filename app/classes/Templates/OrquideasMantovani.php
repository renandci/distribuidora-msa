...
class OrquideasMantovani extends HelperHtml 
{
	public static function template_set_price_01( $pr_venda = array(), $pr_promo = array(), $pr_parcelas = array() ) {
		...
		$html .= $pr_parcelas['preco_promo'] > 0 
			? sprintf('<span class="mt5 %s show">ou em até %sx nos cartões</span>', $pr_parcelas['preco_color'], $pr_parcelas['preco_parcela_x']) : '';
