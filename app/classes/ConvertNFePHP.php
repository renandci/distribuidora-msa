...
class ConvertNFePHP {
	...
	$notas=array();
        ...
        for($l = 0; $l < count($arquivo); $l++) {
		    ...
		    unset(	$dom,$NFe,$infNFe,$ide,$cUF,$cNF,$NatOp,$indPag,$mod,$serie,$nNF,$dhEmi,$dSaiEnt,$hSaiEnt,$tpNF,$cMunFG,
		    ...
		    $infNFe = &$notas[$cur_nota]['infNFe'];
                ...
                case "B": //identificadores [infNFe]
                    //B|cUF|cNF|NatOp|indPag|mod|serie|nNF|dhEmi|dSaiEnt|hSaiEnt|tpNF|cMunFG|TpImp|TpEmis|cDV|tpAmb|finNFe|procEmi|VerProc|dhCont|xJust
	...
	// uma nova nota...
	    $CONTADOR_NOTAS++;
            ...
            //B|cUF|cNF|NatOp|intPag|mod|serie|nNF|dhEmi|dSaiEnt|tpNF|cMunFG|TpImp|TpEmis|CDV|TpAmb|FinNFe|ProcEmi|VerProc|
            $cUF = $ide->getElementsByTagName('cUF')->item(0)->nodeValue;
            $cNF = $ide->getElementsByTagName('cNF')->item(0)->nodeValue;
	    ...
	    $tpNF = $ide->getElementsByTagName('tpNF')->item(0)->nodeValue;
            ...
            $txt .= "B|$cUF|$cNF|$natOp|$indPag|$mod|$serie|$nNF|$dhEmi|$dSaiEnt|$hSaiEnt|$tpNF|$cMunFG|$tpImp|$tpEmis|$cDV|$tpAmb|$finNFe|$procEmi|$verProc|\r\n";
	    ...
	    $xPais = !empty($enderEmit->getElementsByTagName("xPais")->item(0)->nodeValue) ? $enderEmit->getElementsByTagName("xPais")->item(0)->nodeValue : '';
            ...
            //D|CNPJ|xOrgao|matr|xAgente|fone|UF|nDAR|dhEmi|vDAR|repEmi|dPag|
            if( isset($avulsa) ){
                ...
                $dhEmi = !empty($avulsa->getElementsByTagName("dhEmi")->item(0)->nodeValue) ? $avulsa->getElementsByTagName("dhEmi")->item(0)->nodeValue : '';
                ...
                $txt .= "D|$CNPJ|$xOrgao|$matr|$xAgente|$fone|$UF|$nDAR|$dhEmi|$vDAR|$repEmi|$dPag|\r\n";
            } //fim avulsa
		...
		$ICMSPart = $imposto->getElementsByTagName("ICMSPart")->item(0);
		$ICMSST = $imposto->getElementsByTagName("ICMSST")->item(0);
		...
		//$vCredICMSSN
		//switch ($CSON) {
		 //   case '101':	// CSON - 101	//N10c|Orig|CSOSN|pCredSN|vCredICMSSN|
