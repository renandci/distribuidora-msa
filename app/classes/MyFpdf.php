...
require_once PATH_ROOT . '/app/vendor/stavarengo/php-sigep-fpdf/fpdi.php';
/**
 * Extende a classe principal
 */
/**
 * Extende a classe principal
 */
class MyFpdf extends FPDISigep
{
	...
	// /**
	 // * Cria um nova função com conversão dos caracteres
	 // *
	 // */
	// public function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='')
	// {
		// if ( ! empty( $txt ) )
			// if (mb_convert_encoding($txt, 'UTF-8', 'ISO-8859-1'))
