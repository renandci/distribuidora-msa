    ...
    public function __construct($_conf = null) {
        if(is_null($_conf)){
            $_conf = [
                ...
                'urlParser' => 'https://www2.correios.com.br/sistemas/rastreamento/resultado_semcontent.cfm'
                // 'urlParser' => 'https://www2.correios.com.br/sistemas/rastreamento/newprint.cfm'
                // 'urlParser' => 'https://www2.correios.com.br/sistemas/rastreamento/ctrl/ctrlRastreamento.cfm'
            ];
        }
