...
<div class="row">
	<form action="/adm/relatorio/relatorio-mais-vendidos.php" method="post" target="_blank" class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div>
							...
							<span class="show"><input type="text" name="dataInicial" class="datepicker w80" /></span>
						</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div>
							...
							<span class="show"><input type="text" name="dataFinal" class="datepicker w80" /></span>
						</div>
						<div class="mt5 ft13px bold-3">
