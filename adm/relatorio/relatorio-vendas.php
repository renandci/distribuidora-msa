...
<div class="row">
	<form action="/adm/relatorio/relatorio-vendas-print.php" method="post" target="_blank" class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb15">
						...
						<span class="pull-left w100 mt5">
							<input type="radio" id="17" name="tipo_relatorio" value="R"/>
							<label for="17" class="input-radio"></label> RECOMPRAS
						</span>
					</div>
				</div>
			</div>
