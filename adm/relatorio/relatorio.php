...
<div class="row">
	<form action="/adm/relatorio/relatorio-vendas.php" method="post" target="_blank" class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading panel-store text-uppercase">RELATÓRIOS DE VENDAS</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb15">
						<div>
							<span class="show bold-3">Data Inicial:</span>
							<span class="show"><input type="text" name="data_ini" class="datepicker w100 black-10"/></span>
						</div>
						<div class="mt5 ft13px bold-3 mb15">
							<input type="checkbox" id="11" name="clientes" value="true" checked />
							<label for="11" class="input-checkbox"></label> MOSTRAR CLIENTES
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb15">
						<div>
							<span class="show bold-3">Data Final:</span>
							<span class="show"><input type="text" name="data_fin" class="datepicker w100"/></span>
						</div>
						<div class="mt5 ft13px bold-3">
							<input type="checkbox" id="12" name="produtos" value="true" checked />
							<label for="12" class="input-checkbox"></label> MOSTRAR PRODUTOS
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb15">
						<div>
						...
						<div class="mt5 ft13px bold-3">
							<input type="checkbox" id="22" name="cupom" value="true"/>
							<label for="22" class="input-checkbox"></label> SOMENTE CUPOM DESCONTO
						</div>
					</div>
